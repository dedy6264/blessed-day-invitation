...
<div class="mb-4 d-sm-flex align-items-center justify-content-between">
    ...
    <div>
        @if(isset($editRoute))
        <a href="{{ route($editRoute, $galleryImage) }}" class="shadow-sm d-sm-inline-block btn btn-sm btn-warning">
            <i class="fas fa-edit fa-sm text-white-50"></i> Edit
        </a>
        @endif
        @if(isset($indexRoute))
        <a href="{{ route($indexRoute) }}" class="shadow-sm d-sm-inline-block btn btn-sm btn-secondary">
