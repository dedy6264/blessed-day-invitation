...
@section('title', $title ?? 'Create Bank Account')

@section('content')
<!-- Page Heading -->
<div class="mb-4 d-sm-flex align-items-center justify-content-between">
    <h1 class="mb-0 text-gray-800 h3">{{ $title ?? 'Create Bank Account' }}</h1>
    @if(isset($indexRoute))
    ...
    <div class="col-12">
        <div class="mb-4 shadow card">
            <div class="py-3 card-header">
                <h6 class="m-0 font-weight-bold text-primary">{{ $title ?? 'Create Bank Account' }}</h6>
            </div>
            <div class="card-body">
                @if(isset($storeRoute))
