...
@section('title', $title ?? 'Edit Gift')

@section('content')
<!-- Page Heading -->
<div class="mb-4 d-sm-flex align-items-center justify-content-between">
    <h1 class="mb-0 text-gray-800 h3">{{ $title ?? 'Edit Gift' }}</h1>
    @if(isset($indexRoute))
    ...
    <div class="col-12">
        <div class="mb-4 shadow card">
            <div class="py-3 card-header">
                <h6 class="m-0 font-weight-bold text-primary">{{ $title ?? 'Edit Gift' }}</h6>
            </div>
            <div class="card-body">
                ...
                <form method="POST" action="{{ $updateRoute  }}">
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" name="bank_name" id="bank_name" class="form-control" value="{{ old('bank_name', $record->bank_name) }}">
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" name="account_number" id="account_number" class="form-control" value="{{ old('account_number', $record->account_number) }}">
                        <small class="form-text text-muted">Optional - Leave blank for non-financial gifts.</small>
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" name="account_holder_name" id="account_holder_name" class="form-control" value="{{ old('account_holder_name', $record->account_holder_name) }}">
                        <small class="form-text text-muted">Optional - Leave blank for non-financial gifts.</small>
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <select name="gift_type" id="gift_type" class="form-control" required>
                            <option value="gift" {{ old('gift_type', $record->gift_type) === 'gift' ? 'selected' : '' }}>Gift</option>
                            <option value="support" {{ old('gift_type', $record->gift_type) === 'support' ? 'selected' : '' }}>Support</option>
                        </select>
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <textarea name="gift_description" id="gift_description" class="form-control" rows="3">{{ old('gift_description', $record->gift_description) }}</textarea>
